    ...
    def build_model(self, index):
        ...
        for idx in range(len(self.paras.model['hidden_layers'][index])):
            if idx == (len(self.paras.model['hidden_layers'][index]) - 1):
                ...
                model.add(LSTM(input_dim=int(self.paras.n_features),
                                    output_dim=int(self.paras.model['hidden_layers'][index][idx]),
        ...
        # output layer
        model.add(Dense(output_dim=self.paras.model['out_layer']))
